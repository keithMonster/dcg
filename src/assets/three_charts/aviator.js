...
let scene, camera, fieldOfView, aspectRatio, nearPlane,
    farPlane, HEIGHT, WIDTH, renderer, container, THREE;
...
const Sea = function () {
    ...
    let geom = new THREE.CylinderGeometry(600, 600, 800, 40, 1);
    // 在 x 轴旋转几何体
...
function createPlane() {
    ...
    objectLoader.load("src/assets/three_obj/fly.json", function (obj) {
